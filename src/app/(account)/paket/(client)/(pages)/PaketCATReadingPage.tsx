...
import CATQuestionList, { CATQuestionListRef } from "@/components/pages/account/cat/CATQuestionList";
import AutodetectText from "@/components/basics/AutodetectText";
import QuestionWrittenExpression from "@/components/pages/account/cat/QuestionWrittenExpression";
import CATAnswer from "@/components/pages/account/cat/CATAnswer";
import CATFloatingAction from "@/components/pages/account/cat/CATFloatingAction";
...
export default function PaketCATReadingPage({
  quiz,
}: Props) {
  // Props
  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col bg-card rounded-xl shadow-md p-4">
          ...
          <>
            <div className="mt-4 flex flex-col md:flex-row md:gap-0 gap-6">
              {!!qs[active].question_body && (
                <div className="text-base md:w-7/12 xl:mr-6 md:mr-4 border-dark-300 bg-dark-100 dark:bg-dark-300/50 rounded-xl p-4 inset-shadow-sm inset-shadow-black/25">
              ...
              <div className="md:flex-1 text-lg">
                <div className="sticky top-0" style={{ top: (uiLayouts.header?.height || 0) + 12 }}>
                  ...
                  >{`${active + 1}. ${qs[active].question_text}`}</AutodetectText>

                  {!!qs[active].answers?.length && (
                    <CATAnswer
                      className={clsx(["mt-2", isEnded && "pointer-events-none"])}
                      question={qs[active]}
